...
public class RoomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(RoomsActivity.this, android.R.layout.simple_spinner_dropdown_item, items);
        ...
        final MyDb myDb = new MyDb(RoomsActivity.this);
        ...
        startdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        RoomsActivity.this, android.R.style.Theme,mDateSetListener, year, month, day
                );
        ...
        callbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    {
                        ActivityCompat.requestPermissions(RoomsActivity.this, new String[]{
